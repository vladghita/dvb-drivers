...
static const struct ds3103_config dvbsky_ts2020_ds3103_config = {
	.i2c_addr = 0x68,
	.clock = 27000000,
	.i2c_wr_max = 33,
	.clock_out = 0,
	.ts_mode = DS3103_TS_CI,
	.ts_clk = 10000,
	.ts_clk_pol = 1,
	.agc = 0x99,
	.lnb_hv_pol = 0,
...
static struct ts2020_config dvbsky_ts2020_config = {
	.tuner_address = 0x60,
	.clk_out_div = 1,
	.frequency_div = 1103000,
};

static int dvbsky_ts2020_attach(struct dvb_usb_adapter *adap)
{
	struct dvbsky_state *state = adap_to_priv(adap);
	struct dvb_usb_device *d = adap_to_d(adap);
	int ret = 0;
	...
	/* attach demod */
	adap->fe[0] = dvb_attach(ds3103_attach,
			&dvbsky_ts2020_ds3103_config,
			&d->i2c_adap,
			&i2c_adapter);

	if (!adap->fe[0]) {
		dev_err(&d->udev->dev, "dvbsky_ts2020_attach fail.\n");
		ret = -ENODEV;
		goto fail_attach;
	}
	...
	/* attach tuner */
	ts2020_config.fe = adap->fe[0];
	ts2020_config.get_agc_pwm = ds3103_get_agc_pwm;
	strlcpy(info.type, "ts2020", I2C_NAME_SIZE);
	info.addr = 0x60;
	info.platform_data = &ts2020_config;
	request_module("ts2020");
...
static struct dvb_usb_device_properties dvbsky_t2020_props = {
	.driver_name = KBUILD_MODNAME,
	.owner = THIS_MODULE,
	.adapter_nr = adapter_nr,
	.size_of_priv = sizeof(struct dvbsky_state),
	...
	.i2c_algo         = &dvbsky_i2c_algo,
	.frontend_attach  = dvbsky_ts2020_attach,
	.init             = dvbsky_init,
	.get_rc_config    = dvbsky_get_rc_config,
	.streaming_ctrl   = dvbsky_streaming_ctrl,
	.identify_state	  = dvbsky_identify_state,
...
static const struct usb_device_id dvbsky_id_table[] = {
	...
	{ DVB_USB_DEVICE(USB_VID_TERRATEC, USB_PID_TERRATEC_DVBS2CI_V4,
		&dvbsky_t2020_props, "Terratec S7 Rev.4 (Added by Pat !)", RC_MAP_DVBSKY) },
